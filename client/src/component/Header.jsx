    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 backdrop
border border-pink-900/40 bg-pink-700/10 rounded-full text-sm text-black'>
                    <p>New: AI feature integrated</p>

                </div>
                <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700'>
                    Your own <span className='text-pink-500'>blogging</span> <br />Platform</h1>
                <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>Code the Future You Wish to See </p>
...
border border-gray-300 bg-white rounded overflow-hidden' >
                    ...
                    <button type="submit" className='bg-pink-900 text-white px-8 py-2 m-1.5
