...
<button type='submit' className='md:px-12 px-8 h-full text-white bg-pink-700/80 hover:bg-pink-800 transition-all cursor-pointer rounded-md rounded-l-none'>Subscribe</button>
